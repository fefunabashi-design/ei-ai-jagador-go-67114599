...
import { Crown, Check, ShieldCheck, AlertTriangle } from "lucide-react";
...
const Welcome = ({ onStart, loading }: { onStart: () => void; loading: boolean }) => (
...
export const AdminGate = ({ children }: { children: ReactNode }) => {
  ...
  if (status === "none") return <Welcome onStart={startTrial} loading={false} />;
